...
?>
	...
	<?php if (!$this->print) : ?>
		...
		<div class="btn-group pull-right">
			<a class="btn btn-default dropdown-toggle" data-toggle="dropdown" href="#" title="Select to show print and email options"> <span class="icon-cog"></span> <span class="caret"></span> </a>
