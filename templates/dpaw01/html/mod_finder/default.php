...
$output = '<input type="text" name="q" id="mod-finder-searchword" class="form-control input-sm" size="' . $params->get('field_size', 20) . '" value="' . htmlspecialchars(JFactory::getApplication()->input->get('q', '', 'string')) . '" />';
$button = '';
$label = '';
...
// function added prevent the Itemid ever being sent to the search page
...
{
	$button = ' <button class="btn btn-default btn-inverse" type="submit" title="' . JText::_('MOD_FINDER_SEARCH_BUTTON') . '"> Go! </button>';
...
<form id="mod-finder-searchform" action="<?php echo JRoute::_($route); ?>" method="get" class="form-search navbar-form form-inline">
