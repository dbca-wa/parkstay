	...
	function j02210listtariffs_advanced()
		...
		if ( $mrConfig['tariffmode']=="2")
			...
			foreach($tariffList as $tariff)
				...
				$rw['EDIT_URL']=jomresURL(JOMRES_SITEPAGE_URL."&task=editTariff&tariffUid=".$tariff->rates_uid );
				$rw['COPY_URL']=jomresURL(JOMRES_SITEPAGE_URL."&task=editTariff&tariffUid=".$tariff->rates_uid."&clone=1");
				$rw['DELETE_URL']=jomresURL(JOMRES_SITEPAGE_URL."&task=deleteTariff&tariffUid=".$tariff->rates_uid);
