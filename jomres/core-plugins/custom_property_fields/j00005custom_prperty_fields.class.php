...
class j00005custom_prperty_fields
	{
	function j00005custom_prperty_fields()
		{
		...
		$obsolete_plugin_files[] = get_showtime('ePointFilepath').'j00011manager_option_01_custom_fields.class.php';
