...
class j06001easy_blackbook 
	...
	function j06001easy_blackbook()
		...
		jomres_cmsspecific_addheaddata("javascript",get_showtime('eLiveSite').'/js/','jquery.dop.BookingCalendar.js');
		
		if (using_bootstrap())
			jomres_cmsspecific_addheaddata("javascript",get_showtime('eLiveSite').'js/','ui.multiselect_bootstrap.js');
		else
			jomres_cmsspecific_addheaddata("javascript",get_showtime('eLiveSite').'js/','ui.multiselect.js');
		
		jomres_cmsspecific_addheaddata("javascript",get_showtime('eLiveSite').'js/','jquery.scrollTo-min.js');
		
		jomres_cmsspecific_addheaddata("css",get_showtime('eLiveSite').'css/','ui.multiselect.css');
		jomres_cmsspecific_addheaddata("css",get_showtime('eLiveSite').'css/','jquery.dop.BookingCalendar.css');
