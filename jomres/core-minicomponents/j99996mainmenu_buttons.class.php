...
class j99996mainmenu_buttons
	...
	#
	 */
	function j99996mainmenu_buttons()
		{
		...
		$dashboard_category = jr_gettext( "_JOMRES_CUSTOMCODE_JOMRESMAINMENU_RECEPTION_HOME", "dashboard", false, false );
		...
		if ( count( $control_panel_buttons_categorised ) > 0 ) $MiniComponents->triggerEvent( '99997', array ( 'jomres_mainmenu_buttons_categorised' => $control_panel_buttons_categorised, 'management_view' => $management_view ) );
		}
