...
class j04900saveproperty
	...
	function j04900saveproperty( $componentArgs )
		...
		$property_regionPromo = jomresGetParam( $_POST, 'region_promo', "" );
		$booking_configuration = jomresGetParam( $_POST, 'booking_configuration', "" );
		...
		if ( $propertyUid == 0 )
			...
			$query     = "INSERT INTO #__jomres_propertys (`property_name`,`property_street`,`property_town`,
					`property_region`,`property_regionpromo`,`property_booking_configuration`,`property_country`,`property_postcode`,`property_tel`,`property_fax`,
					...
					'$property_town','$property_region','$property_regionPromo','$booking_configuration','$property_country','$property_postcode','$property_tel',
			...
			$query = "UPDATE #__jomres_propertys SET
				...
				`property_regionpromo`='$property_regionPromo',
				`property_booking_configuration`='$booking_configuration',
