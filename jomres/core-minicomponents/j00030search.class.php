...
class j00030search
	...
	function j00030search( $componentArgs )
		...
		// Customised search to meet custom search feature				
					...
					$output[ 'town' ] = '<input class="inputbox" placeholder="PPP Park, Campsite or Region" type="text" name="town"  onfocus="if (this.value ==\'' . $output[ 'JOMRES_SEARCH_TOWN_LABEL' ] . '\') {this.value = \'\'}" /> sdfdsfsd ';
		// End
					$showButton       = true;
					}
				else
