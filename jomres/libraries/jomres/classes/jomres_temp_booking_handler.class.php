...
class jomres_temp_booking_handler
	...
	function jomres_temp_booking_handler()
		...
		$this->tmpguest = array ( "guests_uid" => "", "mos_userid" => "", "existing_id" => "", "firstname" => "", "surname" => "", "house" => "", "street" => "", "town" => "", "state" => "", "country" => "", "postcode" => "", "tel_landline" => "", "tel_mobile" => "", "tel_fax" => "", "ccard_no" => "", "ccard_issued" => "", "ccard_expiry" => "", "ccard_iss_no" => "", "ccard_name" => "", "ccv" => "", "type" => "", "property_uid" => "", "email" => "", "discount" => "0", "tag" => "", "timestamp" => "" );
	...
	function session_jomres_start()
		...
		if ( file_exists( $this->sessionfile ) )
          ...
          //  print_r($data);
            ...
            $this->tmpguest['country'] = "AU";
//print_r($this->tmpguest);
