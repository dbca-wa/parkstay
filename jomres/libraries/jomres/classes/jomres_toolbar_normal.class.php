...
class jomres_toolbar_normal
	...
	#
	 */
	function jomres_toolbar_normal()
		{
	...
	function makeCell( $image, $targetTask, $link, $text, $submitOnClick = false, $submitTask = "" )
		...
		$t     = str_replace( "&#39;", "\'", $t );
		$title = 'title="' . $t . '"';
		if ( $submitOnClick ) $submit = '<a class="jomresmenu" href="javascript:jomres_submitbutton(\'' . $submitTask . '\');"><img src="' . $image . '" alt="' . $text . '" title="' . $text . '" border="0" /></a>';
		else
