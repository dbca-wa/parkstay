...
jr_define( '_JOMRES_COM_MR_EB_GUEST_JOMRES_LANDLINE_EXPL', 'Phone number' );
jr_define( '_JOMRES_COM_MR_EB_GUEST_JOMRES_MOBILE_EXPL', 'Vehicle registration number' );
...
jr_define( '_JOMRES_COM_MR_EB_PAYM_DEPOSIT_PAID_UPDATE', 'Paid in full' );
...
jr_define( '_JOMRES_COM_MR_QUICKRES_STEP2_TITLE', 'Camp sites mud map and list' );
...
jr_define( '_JOMRES_COM_MR_VIEWROOMSPROPERTYCONFIG_TITLE', 'View camp sites & business config' );
...
jr_define( '_JOMRES_COM_MR_VRCT_TAB_ROOMTYPES', 'Site type' );
...
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_LINK', 'Site type' );
...
jr_define( '_JOMRES_FRONT_MR_EB_GUEST_JOMRES_LANDLINE_EXPL', 'Phone number  <small>(mobile preferred) </small>' );
jr_define( '_JOMRES_FRONT_MR_EB_GUEST_JOMRES_MOBILE_EXPL', 'Vehicle registration <small> (if renting, enter - HIRE) </small>' );
jr_define( '_JOMRES_FRONT_MR_QUICKRES_STEP2_NOROOMSINRANGE', 'There are no camp sites available able to satisfy the parameters specified' );
jr_define( '_JOMRES_FRONT_MR_BOOKINGMADE', 'Thank you for booking. Your booking number is' );
jr_define( '_JOMRES_FRONT_MR_BOOKINGMADE2', '<p>If the campground where you are staying is in a park where entry fees apply you may purchase any of a range of parks passes in advance from our online <a href="https://shop.dpaw.wa.gov.au/" alt-text="Parks and Wildlife - Shop">shop </a> or pay a single entry <a href="/about-camping/fees/">fee</a> on arrival (may be cash only at a staffed or unstaffed registration station).</p>' );
jr_define( '_JOMRES_FRONT_MR_BOOKINGMADE1', '<p><strong>Your booking will be confirmed by email.</strong> Keep your email safe, you may need to show it (either printed or on a mobile device screen) at any time during your stay. <br />
    If you do not receive an email in your inbox check your email filter settings, junk or spam folders and that your mailbox is not full.<br /><br />
    If you need to contact us about your booking, include your booking number and the name of the campground.
    </p>' );
...
jr_define( '_JOMRES_FRONT_MR_EMAIL_TEXT_ROOM', 'Camp site(s): ' );
...
jr_define( '_JOMRES_FRONT_MR_EMAIL_TEXT_LANDLINE', 'Phone number: ' );
jr_define( '_JOMRES_FRONT_MR_EMAIL_TEXT_MOBILE', 'Vehicle registration number:' );
...
jr_define( '_JOMRES_FRONT_MR_BOOKED', 'Camp sites booked' );
...
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_NOALLOWANCE', 'No allowance can be made for meals not taken or for camp sites not occupied for the full period of the booking. With this in mind we strongly recommend that you use a holiday insurance facility.' );
...
jr_define( '_JOMRES_COM_MR_ROOM_DELETED', 'Camp sites deleted' );
jr_define( '_JOMRES_COM_MR_ROOMFEATURE_DELETE', 'Delete resource feature' );
jr_define( '_JOMRES_COM_MR_ROOMFEATURE_UNABLETODELETE', 'Unable to remove this resource feature, it is assigned to a camp site or sites. Remove the feature from those resources and retry.' );
...
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_MAPPINGLINK', 'Location' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_PROPDESCRIPTION', 'About' );
...
jr_define( '_JOMRES_COM_A_VISITORSCANBOOKONLINE_DESC', 'Set this to Yes to ensure that visitors can book camp sites online.' );
...
jr_define( '_JOMRES_COM_A_BOOKING', 'Booking camp sites' );
...
jr_define( '_JOMRES_COM_A_SINGLEROOMPROPERTY_DESC', 'EG you are renting out a business, rather than camp sites in that business. If this is the case, then you must make sure that you only have the one resource registered against each business.' );
...
jr_define( '_JOMRES_COM_AVLCAL_PROVISIONALCOLOUR', 'Cell bgcolour for provisionally booked camp sites (bookings for which a deposit has not been taken)' );
...
jr_define( '_JOMRES_FRONT_GUEST_EMAIL_TEXT_THANKS', 'Thank you for making your booking for' );
jr_define( '_JOMRES_FRONT_GUEST_EMAIL_TEXT_SUMMARY', '' );
jr_define( '_JOMRES_FRONT_GUEST_EMAIL_TEXT_ANYQUESTIONS', 'If you need to contact us about this booking, quote the campground name and your booking number.');
//    If you have any questions regarding this booking or any other service, then please do not hesitate to contact us.' );
jr_define( '_JOMRES_FRONT_GUEST_EMAIL_TEXT_TELEPHONE', 'The telephone number for the Department’s nearest visitor centre or regional office is:');
...
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_STAGE2_ERROR', 'There was an error attempting to book these campsites, one or more of the camp sites you selected is not free.' );
...
jr_define( '_JOMRES_COM_A_CLICKFORMOREINFORMATION', 'Activities' );
...
jr_define( '_JOMRES_FRONT_TARIFFS_PPPN', 'Per adult per night' );
...
jr_define( '_JOMRES_FRONT_NORESULTS', '<p><b>There is no camp site available for booking for the period you have selected, try changing your dates.</b><br/>
    <!--<ul>
    <li>\'Search again\' button – returns to home page for all search options</li>
    </ul>-->
</p>');


jr_define( '_JOMRES_AREYOUSURE', 'Are you sure you wish to do this?' );
jr_define( '_JOMRES_FRONT_MR_MENU_BOOKAROOM', 'New provisional booking' );
...
jr_define( '_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS_TITLE', 'Show camp sites and availability below this link' );
...
jr_define( '_JOMRES_NUMBEROFROOMSAVAILABLE', 'Number of camp sites available' );
jr_define( '_JOMRES_BACKTOPROPERTYDETAILSLINK', 'back to campground details' );
...
jr_define( '_JOMRES_AJAXFORM_PARTICULARS', '1. Select dates and campers' );
//jr_define( '_JOMRES_AJAXFORM_PARTICULARS_DESC', 'Select the details of your booking requirements' );
jr_define( '_JOMRES_AJAXFORM_PARTICULARS_DESC', ' ' );
jr_define( '_JOMRES_AJAXFORM_AVAILABLE', 'Availability ' );
jr_define( '_JOMRES_AJAXFORM_AVAILABLE_DESC', '2. Select camp site' );
...
jr_define( '_JOMRES_AJAXFORM_AVAILABLEROOMS', 'Available sites' );
jr_define( '_JOMRES_AJAXFORM_SELECTEDROOMS', 'Selected sites' );
...
jr_define( '_JOMRES_AJAXFORM_BILLING_TOTALINPARTY', 'Total campers' );
jr_define( '_JOMRES_AJAXFORM_CLICKHERECAPTION', 'Add to your selection' );
//jr_define( '_JOMRES_AJAXFORM_CLICKHERECAPTION', 'Add' );
jr_define( '_JOMRES_AJAXFORM_CLICKHERECAPTION_REMOVE', 'Remove from your selection' );
//jr_define( '_JOMRES_AJAXFORM_CLICKHERECAPTION_REMOVE', 'Remove');
...
jr_define( '_JOMRES_COM_A_SHOWROOMSLISTLINK', 'Show link to camp sites list page in business details page?' );
...
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_TOO_MANY_IN_PARTY_FOR_TARIFFS', 'No more than 12 campers 6 years and older' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_MORE_ROOMS_THAN_GUESTS', '<b>Too many camp sites for number of guests</b>' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_TOO_MANY_GUESTS_FOR_BEDS', 'Too many guests for the available beds' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_CHOOSE_MORE_ROOMS', 'You need to choose more camp sites' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_SELECT_A_ROOM', '<b>Select a camp site</b>' );
...
jr_define( '_JOMRES_BOOKINGFORM_NOROOMSSELECTEDYET', 'No camp sites selected yet' );
...
jr_define( '_JOMRES_COM_LIMITROOMSLIST', 'Available camp sites/tariff limit' );
jr_define( '_JOMRES_COM_LIMITROOMSLIST_DESC', 'Use this input to limit the number of available camp sites & tariffs that are listed in the booking form. Set it to zero if you do not want limiting enabled. ' );
jr_define( '_JOMRES_SRP_WEHAVENOVACANCIES', '<b>There is no camp site continuously available for this period. Shorten your stay or change your arrival date. (You may make consecutive bookings for different camp sites, but your total stay must not exceed 28 nights)</b>' );
...
jr_define( '_JOMRES_COM_WEEKENDDAYS_DESC', 'Set your weekend days. Tariffs that allow or disallow weekends will take this setting into account when generating the camp sites list.' );
...
jr_define( '_JOMRES_SEARCH_GEO_REGIONSEARCH', 'List all places by region' );
...
Normal mode is the most simplistic but it's the easiest to understand because it will cross reference camp sites and tariffs to resource/business types and allows you to configure  camp sites and prices on the same page.<br/>
...
<br/>
Because Normal and Micromanage modes require a specific set up of  camp sites and tariffs for the tariff mode to work the system may need to reset some data to make the current tariff configurations compatible with the current tariff editing mode.<br/>
<br/>
...
jr_define( '_JOMRES_COM_A_LISTROOMSINPROPERTYDETAILS', 'Show camp sites list in business details page?' );
...
jr_define( '_JOMRES_AJAXFORM_ACCOMMODATION_NIGHTS', "" );
...
jr_define( '_JOMRES_AJAXFORM_PRICE_SUMMARY', "Camping fee " );
...
jr_define( '_JOMRES_CONFIRMATION_AMEND', "Change details" );
...
jr_define( '_JOMRES_FRONT_MR_MENU_CONTACTHOTEL_TITLE', 'Please enter the message you\'d like to send to us about' );
jr_define( '_JOMRES_FRONT_MR_MENU_CONTACTHOTEL', 'New provisional booking' );
jr_define( '_JOMRES_FRONT_MR_MENU_CONTACTHOTEL_SUBJECT', 'Business enquiry from ' );
jr_define( '_JOMRES_FRONT_MR_MENU_CONTACTHOTEL_THANKS', 'Thank you for your enquiry, your message has been sent to the visitor centre or regional office for the campground, and copied to your own address for your records. They will respond to you as soon as possible with their reply.' );
...
//jr_define( '_JOMRES_BOOKINGFORM_LOOKRIGHT', 'Please select your required accommodation from the list below by clicking on the camp sites.' );
jr_define( '_JOMRES_BOOKINGFORM_LOOKRIGHT', 'Select a camp site from the ‘Available camp sites list’ below by clicking the Add (green) button' );
...
jr_define( '_JOMRES_AVLCAL_FULLYBOOKED', "Fully booked / No booking" );
...
jr_define( '_JOMRES_COM_MR_EDITBOOKING_ADMIN_HISTORICBOOKINGS', 'Cancelled bookings' );
...
//jr_define( '_JRPORTAL_HORIZROOMSLIST_ESTIMATEWARNING', "Please note that camp sites prices listed are estimates and the full price of the booking will not be calculated until you have added a camp site or camp sites to your selection." );
jr_define( '_JRPORTAL_HORIZROOMSLIST_ESTIMATEWARNING', "");
...
jr_define( '_JOMRES_FRONT_MR_MENU_CONTACT_AGENT', 'New provisional booking' );
...
//jr_define( '_JOMRES_NUMBER_OF_ROOMS', 'Number of camp sites' );
jr_define( '_JOMRES_NUMBER_OF_ROOMS', 'Max persons per site' );
...
jr_define( '_JOMRES_QUICK_INFO', "Features" );
...
jr_define( '_JOMRES_PROPERTYLIST_LAYOUT_LIST', '<i class="icon-list"></i> List view' );
jr_define( '_JOMRES_PROPERTYLIST_LAYOUT_TILE', '<i class="icon-grid"></i> Photo view' );
